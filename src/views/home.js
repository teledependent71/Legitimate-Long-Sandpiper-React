...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Legitimate Long Sandpiper</title>
        <meta property="og:title" content="Legitimate Long Sandpiper" />
      </Helmet>
      <div className="home-header">
        ...
        >
          <span className="logo">CARZ</span>
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              <span className="bodySmall">Home</span>
              <span className="home-nav22 bodySmall">Cars</span>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav221 bodySmall">Cars</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Find the perfect vehicle for your lifestyle</span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Innovative Features for an Unforgettable Drive
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Discover the cutting-edge features that make our cars
            ...
            <div className="home-container03">
              <FeatureCard
                heading="Advanced Safety Features"
                subHeading="Equipped with the latest safety technology to keep you and your passengers secure on the road."
              ></FeatureCard>
              <FeatureCard
                heading="Efficient Fuel Consumption"
                subHeading="Optimized for fuel efficiency, saving you money at the pump without compromising performance."
              ></FeatureCard>
              <FeatureCard
                heading="Smart Connectivity"
                subHeading="Stay connected on the go with seamless integration for your devices and apps."
              ></FeatureCard>
              <FeatureCard
                heading="Luxurious Interior Design"
                subHeading="Experience comfort and style with premium materials and thoughtful design details."
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Explore our pricing options and select the plan that suits
                  your needs best.
                </span>
              </span>
            </span>
            ...
            <div className="freePricingCard home-pricing-card">
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">
                    Access to basic car listings
                  </span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">Limited photo uploads</span>
                </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container15">
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">Unlimited car listings</span>
                </div>
                <div className="home-container18">
                  <span className="home-text52">✔</span>
                  <span className="bodySmall">
                    Up to 10 photo uploads per listing
                  </span>
                </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              ...
              <div className="home-container23">
                ...
                <div className="home-container26">
                  ...
                  <span className="bodySmall">
                    Up to 20 photo uploads per listing
                  </span>
                </div>
                <div className="home-container27">
                  <span className="home-text66">✔</span>
                  <span className="bodySmall">24/7 phone support</span>
                </div>
                <div className="home-container28">
                  <span className="home-text67">✔</span>
                  <span className="bodySmall">Social media promotion</span>
                </div>
              </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  At our dealership, we offer a wide range of new and used cars
                  to suit every need and budget. Whether you&apos;re looking for
                  a sleek sedan, a spacious SUV, or a powerful truck, we have it
                  all. Our team of experts is here to help you find the car of
                  your dreams.
                </span>
                <span>
                  <span
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="We sell a variety of cars including sedans, SUVs, trucks, and electric vehicles."
                question="What type of cars do you sell?"
              ></Question1>
              <Question1
                answer="Yes, we work with various financing partners to provide flexible financing options for our customers."
                question="Do you offer financing options for car purchases?"
              ></Question1>
              <Question1
                answer="Yes, we accept trade-ins as part of the car purchasing process. Our team will assess the value of your current car."
                question="Can I trade in my current car for a new one?"
              ></Question1>
              <Question1
                answer="Yes, we offer warranty options for our cars to provide peace of mind to our customers. Details vary based on the vehicle."
                question="Do you provide warranty for the cars sold?"
              ></Question1>
              <Question1
                answer="You can easily schedule a test drive by contacting our dealership either through phone or by filling out the online form on our website."
                question="How can I schedule a test drive for a car?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container31">
            ...
            <nav className="home-nav1">
              <span className="bodySmall">Home</span>
              <span className="home-nav222 bodySmall">Cars</span>
